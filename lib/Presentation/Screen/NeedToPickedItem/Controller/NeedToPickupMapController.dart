...
class NeedToPickupController extends GetxController {
  ...
  static NeedToPickupController to = Get.find();

  RxSet<Marker> markers = <Marker>{}.obs;

  Future<void> loadMarkers(
      {LatLng? orderPlace, LatLng? vendorLocation, LatLng? myLocation}) async {
  ...
  Future<void> _setMyLocationMarker() async {
    ...
    NeedToPickupController.to.markers.refresh();
  }
  ...
  Future<void> _setVendorMarker(LatLng? vendorLocation) async {
    ...
    NeedToPickupController.to.markers.add(new Marker(
        icon: BitmapDescriptor.fromBytes(await MapFunction.getBytesFromAsset(
  ...
  Future<void> _setOrderPlaceMarker(LatLng orderPlace) async {
    NeedToPickupController.to.markers
